...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { number_of_questions: @test.number_of_questions, score: @test.score } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { number_of_questions: @test.number_of_questions, score: @test.score } }
